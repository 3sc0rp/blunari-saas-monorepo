-- Apply Catering Widget Configuration Migration
...
DROP POLICY IF EXISTS "Tenants can view their own catering widget config" ON public.catering_widget_configs;
...
DROP POLICY IF EXISTS "Tenants can update their own catering widget config" ON public.catering_widget_configs;
...
DROP POLICY IF EXISTS "Tenants can insert their own catering widget config" ON public.catering_widget_configs;
...
SELECT '✅ Catering widget configuration system created successfully!' as status;
SELECT 'Default configs created for ' || COUNT(*) || ' tenants' as info
FROM public.catering_widget_configs;
