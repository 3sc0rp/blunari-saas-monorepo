...
test.describe("Visual Regression Tests", () => {
  ...
  test("Tables page visual snapshot", async ({ page }) => {
    ...
    await page.waitForSelector('[data-testid="floor-plan"]', {
      timeout: 15000,
    });
    await page.waitForLoadState("networkidle");
  ...
  test("Analytics page visual snapshot", async ({ page }) => {
    ...
    await page.waitForSelector('[data-testid="booking-patterns-chart"]', {
      timeout: 15000,
    });
    await page.waitForLoadState("networkidle");
  ...
  test("Booking widget steps visual snapshots", async ({ page }) => {
    ...
    await page.waitForSelector('[data-testid="party-size-step"]', {
      timeout: 10000,
    });
    ...
    await page.click('[data-testid="continue-button"]');
    await page.waitForSelector('[data-testid="guest-details-step"]', {
      timeout: 10000,
    });
