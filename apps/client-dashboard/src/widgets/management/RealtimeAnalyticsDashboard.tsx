              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-2xl font-bold text-orange-600">
                    {formatSessionDuration(metrics.average_session_duration)}
                  </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {metrics.top_events.length > 0 ? (
                metrics.top_events.slice(0, 5).map((event, index) => (
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">
                  {metrics.performance_summary.avg_load_time}ms
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Avg Render Time</span>
                <span className="font-medium">
                  {metrics.performance_summary.avg_render_time}ms
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Error Rate</span>
                <span className={`font-medium ${
                  metrics.performance_summary.error_rate > 5 
                    ? 'text-red-600' 
                    : metrics.performance_summary.error_rate > 1 
                      ? 'text-yellow-600' 
                      : 'text-green-600'
                }`}>
                  {metrics.performance_summary.error_rate}%
                </span>
              </div>
            </CardContent>
          </Card>
