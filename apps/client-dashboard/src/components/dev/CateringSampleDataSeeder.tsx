...
export const CateringSampleDataSeeder: React.FC = () => {
  ...
  const seedSampleData = async () => {
    ...
    try {
      ...
      setStatus(
        "✅ Sample catering data added successfully! Refresh the page to see the packages.",
      );
    } catch (error) {
  ...
  return (
    <div className="p-4 border border-dashed border-orange-300 rounded-lg bg-orange-50">
      ...
      <p className="text-sm text-orange-700 mb-4">
        This tool attempts to add sample catering packages for testing. Note:
        Catering system requires proper database setup.
      </p>
