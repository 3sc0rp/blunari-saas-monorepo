          ...
          {payload.map((entry, index: number) => (
            <div key={index} className="flex items-center gap-2 text-body-sm">
              ...
              <span className="font-medium text-text">
                ...
                entry.dataKey === "comparisonRevenue"
    ...
    <Card className="bg-surface border-surface-2">
            ...
            <div className="flex items-center gap-4">
              ...
              {comparisonGrowth && (
                <div className="flex items-center gap-1 text-xs text-text-muted">
                  vs previous:
                  <span
                    className={`font-medium ${comparisonGrowth.isPositive ? "text-success" : "text-danger"}`}
                  >
                    {comparisonGrowth.isPositive ? "+" : "-"}
                    {comparisonGrowth.growth.toFixed(1)}%
                  </span>
                </div>
              )}
            </div>
      ...
      <CardContent className="pt-0">
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="text-center p-3 rounded-md bg-surface-2">
            <div className="text-h3 font-semibold text-success font-tabular">
              {data.revenueGrowth}%
            </div>
