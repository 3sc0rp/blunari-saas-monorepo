...
>(({ className, children, ...props }, ref) => {
  ...
  const contentProps = {
    ...(props as any),
    ...(props["aria-describedby"] || hasDescription
      ? {}
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...contentProps}
      >
        {/* Fallback, visually-hidden description for a11y if none provided by caller */}
        {!(props as any)["aria-describedby"] && !hasDescription && (
          <p id={generatedDescriptionId} className="sr-only">
            Dialog window. Use the content and actions to complete this task.
          </p>
        )}
        {children}
