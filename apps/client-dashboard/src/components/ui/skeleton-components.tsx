...
export const SkeletonBox: React.FC<{ className?: string }> = ({
  ...
  <div
    className={`animate-pulse motion-reduce:animate-none bg-surface-2 rounded-md ${className}`}
  />
);
...
export const SkeletonChart: React.FC<{
  ...
  showLegend?: boolean;
  className?: string;
}> = ({ height = "h-64", showLegend = true, className = "" }) => (
  <Card className={className}>
    <CardHeader className="space-y-2">
    ...
    <CardContent className="space-y-4">
      {/* Chart area */}
      <div
        className={`relative ${height} bg-surface-2 rounded-lg animate-pulse motion-reduce:animate-none`}
      >
        {/* Mock chart elements */}
