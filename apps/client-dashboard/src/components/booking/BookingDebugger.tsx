    ...
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <div className="text-sm text-muted-foreground">
          Test the complete booking flow for slug:{" "}
        ...
        <div className="flex items-center gap-4">
          ...
          <input
            ...
            onChange={(e) =>
              setTestData((prev) => ({
                ...prev,
                party_size: parseInt(e.target.value) || 2,
              }))
            }
          ...
          <input
            ...
            onChange={(e) =>
              setTestData((prev) => ({ ...prev, service_date: e.target.value }))
            }
