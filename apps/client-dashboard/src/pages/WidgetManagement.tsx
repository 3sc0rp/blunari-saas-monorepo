...
const WidgetManagement: React.FC = () => {
  ...
  const saveConfiguration = () => {
    toast({
      ...
      description: `${widgetType === 'booking' ? 'Booking' : 'Catering'} widget settings have been saved.`,
    });
  };
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage, configure, and preview your embeddable widgets for both booking and catering
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border rounded-lg p-4 bg-muted/20">
                <div 
                  className={`mx-auto bg-white rounded-lg shadow-lg overflow-hidden ${deviceConfigs[previewDevice].containerClass}`}
                  style={{ maxWidth: '100%' }}
                >
                  <iframe
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center justify-between p-3 border rounded-lg">
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-muted-foreground">Allow customers to join waitlist</p>
                        </div>
                        <Switch
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Quick setup for your booking widget
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {Object.values(bookingConfig).filter(v => v === true).length} enabled
                    </span>
                  </div>
                </div>
                <div className="flex gap-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Quick setup for your catering widget
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm">Features</span>
                    <span className="text-sm text-muted-foreground">
                      {Object.values(cateringConfig).filter(v => v === true).length} enabled
                    </span>
                  </div>
                </div>
                <div className="flex gap-2">
                  ...
                  <Button 
                    ...
                    className="flex-1"
                  >
                    <a href={cateringUrl} target="_blank" rel="noopener noreferrer">
                      Preview
                    </a>
                  </Button>
                </div>
