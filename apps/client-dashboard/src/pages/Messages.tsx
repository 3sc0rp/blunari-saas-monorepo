...
const Messages: React.FC = () => {
  ...
  const [conversations] = useState<Conversation[]>([
    {
      ...
      last_message:
        "Hi, I would like to make a reservation for tonight at 7 PM for 4 people.",
  ...
  const [messages] = useState<Message[]>([
    ...
    },
    {
      ...
      content:
        "Hi, we have a dinner reservation tomorrow but one of our guests has celiac disease. Can you accommodate gluten-free options?",
      message_type: "text",
      status: "read",
    ...
    },
    {
      ...
      content:
        "Absolutely! We have several gluten-free options available. I'll make sure to note this on your reservation and our chef will be informed.",
      message_type: "text",
      status: "read",
