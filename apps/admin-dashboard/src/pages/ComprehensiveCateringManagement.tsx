...
const StatusBadge: React.FC<{ status: CateringStatus }> = ({ status }) => {
  const colorClass =
    CATERING_STATUS_COLORS[status] || "text-gray-600 bg-gray-50";
  return (
    <Badge
      variant="secondary"
      className={`${colorClass} font-medium capitalize`}
    >
      {status.replace("_", " ")}
    </Badge>
  );
      ...
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
          <div className="flex items-center text-gray-600">
            ...
            {formatTime(order.event_start_time)}
          </div>
          <div className="flex items-center text-gray-600">
        ...
        <div className="flex items-center justify-between">
          <Badge variant="outline" className="text-xs">
            {
              CATERING_SERVICE_TYPE_LABELS[
                order.service_type as CateringServiceType
              ]
            }
          </Badge>
          <div className="flex space-x-2">
            ...
            <Select
              ...
              onValueChange={(status) =>
                onStatusUpdate(order.id, status as CateringStatus)
              }
            >
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {order.event_duration_hours || 4} hours
                    </p>
                  </div>
                  <div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">
                  Catering System Not Ready
                </h3>
                <p className="text-gray-600 mb-4">
                  Apply the database migration to enable full catering
                  functionality.
                </p>
        ...
        <TabsContent value="settings">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">
                Configure catering system settings, pricing rules, and business
                policies.
              </p>
            </CardContent>
          </Card>
