...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-primary text-primary-foreground hover:shadow-glow active:scale-95 shadow-elegant",
        destructive:
        ...
        ghost:
          "hover:bg-accent/10 hover:text-accent transition-all duration-200 active:scale-95",
        ...
        premium:
          "bg-gradient-primary text-primary-foreground hover:scale-[1.02] shadow-elegant hover:shadow-glow border border-primary-light/20 font-semibold",
        success:
          "bg-success text-success-foreground hover:bg-success/90 shadow-card hover:shadow-elegant active:scale-95",
        warning:
          "bg-warning text-warning-foreground hover:bg-warning/90 shadow-card hover:shadow-elegant active:scale-95",
        glass:
          "bg-white/10 backdrop-blur-md border border-white/20 text-foreground hover:bg-white/20 shadow-card hover:shadow-elegant active:scale-95",
        gradient:
          "bg-gradient-secondary text-secondary-foreground hover:scale-[1.02] shadow-card hover:shadow-glow active:scale-95",
      },
      size: {
