...
export function NotificationsTab({
  ...
  const updateEmailNotification = (
    key: keyof typeof editedPreferences.emailNotifications,
    value: boolean,
  ) => {
  ...
  const updateSMSNotification = (
    key: keyof typeof editedPreferences.smsNotifications,
    value: boolean,
  ) => {
    setEditedPreferences((prev) => ({
      ...prev,
  ...
  const updateDashboardNotification = (
    key: keyof typeof editedPreferences.dashboardNotifications,
    value: boolean,
  ) => {
    setEditedPreferences((prev) => ({
      ...prev,
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Get notified when bookings are confirmed or modified
                </p>
              </div>
              <Switch
                id="booking-confirmations"
                checked={
                  editedPreferences.emailNotifications.bookingConfirmations
                }
                onCheckedChange={(checked) =>
                  updateEmailNotification("bookingConfirmations", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateEmailNotification("systemAlerts", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateEmailNotification("weeklyReports", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateEmailNotification("securityAlerts", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Changes to your account or profile
                </p>
              </div>
              <Switch
                id="account-updates"
                ...
                onCheckedChange={(checked) =>
                  updateEmailNotification("accountUpdates", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateEmailNotification("marketingEmails", checked)
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSMSNotification("urgentAlerts", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSMSNotification("bookingReminders", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Notifications about planned or unplanned downtime
                </p>
              </div>
              <Switch
                id="system-downtime"
                ...
                onCheckedChange={(checked) =>
                  updateSMSNotification("systemDowntime", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Suspicious login attempts and security breaches
                </p>
              </div>
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSMSNotification("securityAlerts", checked)
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Show live updates as they happen
                </p>
              </div>
              <Switch
                id="real-time-updates"
                checked={
                  editedPreferences.dashboardNotifications.realTimeUpdates
                }
                onCheckedChange={(checked) =>
                  updateDashboardNotification("realTimeUpdates", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Show popup notifications in the corner
                </p>
              </div>
              <Switch
                id="show-toasts"
                ...
                onCheckedChange={(checked) =>
                  updateDashboardNotification("showToasts", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateDashboardNotification("soundEnabled", checked)
                  }
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Show browser notifications when tab is not active
                </p>
              </div>
              <Switch
                id="desktop-notifications"
                checked={
                  editedPreferences.dashboardNotifications.desktopNotifications
                }
                onCheckedChange={(checked) =>
                  updateDashboardNotification("desktopNotifications", checked)
                }
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-muted/50 rounded-lg">
              ...
              <Badge variant="secondary">
                {
                  Object.values(editedPreferences.emailNotifications).filter(
                    Boolean,
                  ).length
                }{" "}
                enabled
            ...
            <div className="text-center p-4 bg-muted/50 rounded-lg">
              ...
              <Badge variant="secondary">
                {
                  Object.values(editedPreferences.smsNotifications).filter(
                    Boolean,
                  ).length
                }{" "}
                enabled
            ...
            <div className="text-center p-4 bg-muted/50 rounded-lg">
              ...
              <Badge variant="secondary">
                {
                  Object.values(
                    editedPreferences.dashboardNotifications,
