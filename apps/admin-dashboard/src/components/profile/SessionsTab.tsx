  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Security Tip:</strong> If you see any unfamiliar sessions or
          locations, terminate them immediately and change your password. You
          can also enable two-factor authentication for additional security.
        </AlertDescription>
      </Alert>
                        ...
                        <div>
                          ...
                          {activity.metadata.deviceTrusted !== undefined && (
                            <span>
                              {" "}
                              • Device:{" "}
                              {activity.metadata.deviceTrusted
                                ? "Trusted"
                                : "Untrusted"}
                            </span>
                          )}
              ...
              <div className="text-2xl font-bold text-blue-600">
                {
                  recentActivity.filter(
                    (a) => a.actionType === "authentication" && a.success,
                  ).length
                }
              </div>
