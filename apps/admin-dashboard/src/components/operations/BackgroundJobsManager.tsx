...
import {
  ...
  SystemMetrics,
  HealthStatus,
} from "@/hooks/useBackgroundOpsAPI";
...
export const BackgroundJobsManager: React.FC = () => {
  ...
  const { loading, getJobs, cancelJob, retryJob, getHealthStatus, getMetrics } =
    useBackgroundOpsAPI();
        ...
        <TabsContent value="metrics" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Real-time performance metrics from the background operations
                service
              </CardDescription>
            </CardHeader>
            <CardContent>
