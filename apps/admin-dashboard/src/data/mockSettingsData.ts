...
export const mockFeatureFlags: FeatureFlag[] = [
  ...
  },
  {
    ...
    description:
      "Automatic table assignment optimization using machine learning",
    enabled: false,
...
export const mockEmailTemplates: EmailTemplate[] = [
  {
    ...
    textContent:
      "Dear {{guest_name}}, Your reservation for {{party_size}} people on {{booking_date}} at {{booking_time}} has been confirmed.",
    variables: [
      {
        key: "guest_name",
        name: "Guest Name",
  ...
  },
  {
    ...
    textContent:
      "Hi {{guest_name}}, This is a friendly reminder about your reservation tomorrow at {{booking_time}}.",
    variables: [
      {
        key: "guest_name",
        name: "Guest Name",
  ...
  },
  {
    ...
    textContent:
      "Hi {{user_name}}, Click the link below to reset your password: {{reset_link}}",
    variables: [
      {
        key: "user_name",
        name: "User Name",
...
export const mockSMSConfiguration: SMSConfiguration = {
  ...
  messageTemplates: {
    booking_confirmation:
      "Hi {{guest_name}}! Your reservation at {{restaurant_name}} for {{party_size}} on {{booking_date}} at {{booking_time}} is confirmed.",
    booking_reminder:
      "Reminder: You have a reservation at {{restaurant_name}} tomorrow at {{booking_time}}.",
    booking_cancellation:
      "Your reservation at {{restaurant_name}} has been cancelled. Reply STOP to opt out.",
  },
  complianceSettings: {
    enableOptOut: true,
...
export const mockMaintenanceWindows: MaintenanceWindow[] = [
  {
    ...
    description:
      "Scheduled database maintenance to improve query performance and update indexes",
    ...
    rollbackPlan:
      "Revert database changes if performance degrades beyond acceptable thresholds",
