...
export const mockDemoTemplates: DemoTemplate[] = [
  {
    ...
    description:
      "Perfect for authentic Italian dining experiences with warm, family-oriented atmosphere",
    features: [
      "Wine pairing recommendations",
      "Large party booking",
      "Chef specials rotation",
      "Allergen management",
    ],
    previewImage:
  ...
  },
  {
    ...
    name: "Fine Dining",
    description:
      "Elegant solution for upscale restaurants focusing on exceptional service and ambiance",
    features: [
      "Tasting menu management",
      "VIP reservation tiers",
      "Sommelier notes",
  ...
  },
  {
    ...
    name: "Casual Dining",
    description:
      "Flexible template for family restaurants, sports bars, and casual dining establishments",
    features: [
      "Quick booking flow",
      "Group reservations",
      "Takeout integration",
  ...
  },
  {
    ...
    name: "Coffee Shop",
    description:
      "Streamlined booking for cafés, coffee shops, and quick-service establishments",
    features: [
      "Express booking",
      "Table time limits",
      "Study space booking",
