  ...
  try {
    ...
    const samplePackages = [
      ...
      },
      {
        ...
        includes_service: true,
        includes_cleanup: true,
        dietary_accommodations: JSON.stringify([
          "vegetarian",
          "vegan",
          "gluten_free",
          "dairy_free",
    ...
    console.log(
      `📊 Total active packages for demo tenant: ${packagesCount.rows[0].count}`,
    );
  } catch (error) {
