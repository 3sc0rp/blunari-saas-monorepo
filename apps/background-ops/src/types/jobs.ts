...
export const AnalyticsAggregationJobSchema = z.object({
  ...
  metrics: z.array(
    z.enum(["conversion", "booking_time", "api_latency", "revenue"]),
  ),
...
export type AnalyticsAggregationPayload = z.infer<
  typeof AnalyticsAggregationJobSchema
>;
export type AvailabilityCacheWarmingPayload = z.infer<
  typeof AvailabilityCacheWarmingJobSchema
>;
