-- Final provision_tenant function - simplified without tenant_settings
-- tenant_settings uses a key-value pattern, not individual columns
-- Can be populated separately if needed
