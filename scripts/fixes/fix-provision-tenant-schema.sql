-- Updated provision_tenant function with correct tenants table schema
-- Matches actual columns: name, slug, timezone, currency, status, description, phone, email, website, address, cuisine_type_id
