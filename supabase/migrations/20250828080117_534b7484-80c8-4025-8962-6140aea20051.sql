...
-- WITH TRANSACTION ROLLBACK FOR DATA INTEGRITY
...
BEGIN
  ...
  EXCEPTION
    WHEN unique_violation THEN
      ...
      RAISE NOTICE 'Provisioning failed: Duplicate key violation (slug or constraint)';
      RAISE EXCEPTION 'A tenant with this slug already exists or a unique constraint was violated';
    WHEN foreign_key_violation THEN
      RAISE NOTICE 'Provisioning failed: Foreign key violation (invalid user_id or cuisine_type_id)';
