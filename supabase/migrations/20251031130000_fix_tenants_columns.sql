-- ============================================================================
-- FIX: Update provision_tenant_atomic_v2 to use correct tenants columns
-- ============================================================================
...
BEGIN
  INSERT INTO tenant_provisioning_audit_v2 (
    ...
    jsonb_build_object(
      ...
      'contact_email', p_tenant_email, 'contact_phone', p_tenant_phone,
  ...
  -- Insert tenant with only columns that exist in the table
  INSERT INTO tenants (
    name,
    slug,
    contact_email,
    ...
    p_currency,
    'active',
    NULL  -- Will be updated after auth user creation
